...
class UIFunctions(MainWindow):
    ...
    def toggleBottom_htr(self, enable):
        if enable:
            # GET WIDTH
            height = self.ui.frame_bottom_htr.height()
            maxExtend = Settings.BOTTOM_BOX_HEIGHT
            standard = 0
            # SET MAX WIDTH
            if height == 0:
            ...
            # ANIMATION
            self.animation = QPropertyAnimation(self.ui.frame_bottom_htr, b"maximumHeight")
            self.animation.setDuration(Settings.TIME_ANIMATION)
    ...
    def toggleBottom_ocr(self, enable):
        if enable:
            # GET WIDTH
            height = self.ui.frame_bottom_ocr.height()
            maxExtend = Settings.BOTTOM_BOX_HEIGHT
            standard = 0
            # SET MAX WIDTH
            if height == 0:
            ...
            # ANIMATION
            self.animation = QPropertyAnimation(self.ui.frame_bottom_ocr, b"maximumHeight")
            self.animation.setDuration(Settings.TIME_ANIMATION)
            self.animation.setStartValue(height)
            self.animation.setEndValue(heightExtended)
            self.animation.setEasingCurve(QEasingCurve.InOutQuart)
